										...
										<tr>
											<td align="center">
												<s:if test="#request.page.hasPrePage">
													<a href="showAllArticleAction.action?currentPage=1">首页</a>
													<a href="showAllArticleAction.action?currentPage=${page.currentPage -1 }">上一页</a>
												</s:if>
												<s:else>
													首页
													上一页
												...
												<s:if test="#request.page.hasNextPage">
													<a href="showAllArticleAction.action?currentPage=${page.currentPage + 1 }">下一页</a>
													<a href="showAllArticleAction.action?currentPage=${page.totalPage }">尾页</a>			
												</s:if>
												<s:else>
													下一页
													尾页
