									...
									<s:iterator value="#request.all" id="art">
										<tr>
											<td bgcolor="#FFFFFF">
												...
												<a href="showArticleAction.action?id=<s:property value='#art.id'/>"><s:property value="#art.title"/></a>
										...
										<tr>
											<td align="center">
												<s:if test="#request.page.hasPrePage">
													<a href="showUserAllArticleAction.action?currentPage=1">首页</a>
													<a href="showUserAllArticleAction.action?currentPage=${page.currentPage -1 }">上一页</a>
												</s:if>
												<s:else>
													首页
													上一页
												...
												<s:if test="#request.page.hasNextPage">
													<a href="showUserAllArticleAction.action?currentPage=${page.currentPage + 1 }">下一页</a>
													<a href="showUserAllArticleAction.action?currentPage=${page.totalPage }">尾页</a>			
												</s:if>
												<s:else>
													下一页
													尾页
