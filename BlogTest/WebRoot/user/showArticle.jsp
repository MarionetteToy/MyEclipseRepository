									...
									<tr>
										<td>
											<table width="1000" cellpadding="6" cellspacing="1"
												...
												<tr>
														<td height="20" bgcolor="#CCC" color="red">评论</td>
												</tr>
												<s:if test="#request.allCri!=null">
												...
												<tr>
													<td align="center">
														<s:if test="#request.page.hasPrePage">
															<a href="showArticleAction.action?id=${requestScope.article.id}&currentPage=1">首页</a>
															<a href="showArticleAction.action?id=${requestScope.article.id}&currentPage=${page.currentPage -1 }">上一页</a>
														</s:if>
														<s:else>
															首页
															上一页
														...
														<s:if test="#request.page.hasNextPage">
															<a href="showArticleAction.action?id=${requestScope.article.id}&currentPage=${page.currentPage + 1 }">下一页</a>
															<a href="showArticleAction.action?id=${requestScope.article.id}&currentPage=${page.totalPage }">尾页</a>			
														</s:if>
														<s:else>
															下一页
															尾页
											...
											<!-- 添加评论，表单 -->	
											<form action="addCritiqueAction.action" method="post">
